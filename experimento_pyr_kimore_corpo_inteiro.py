...
# Experimento Sem separar o corpo na cnn
...
full_body = TempPyramid(seq_input, seq_input_2, seq_input_4, seq_len, n_dim1)

rec = LSTM(int(80*lstm_mult), return_sequences=True)(full_body)
