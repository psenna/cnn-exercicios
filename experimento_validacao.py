...
train_x, train_y, valid_x, valid_y, test_x, test_y = Split.treino_validacao_teste(Correct_data, Correct_label, Incorrect_data, Incorrect_label, nr)

train_x, valid_x, test_x, train_x_2, valid_x_2, test_x_2, train_x_4, valid_x_4, test_x_4, train_x_8, valid_x_8, test_x_8 = TemporalSample.treino_validacao_teste(train_x, valid_x, test_x)

trainx = SplitBodyParts.reorder_data(train_x)
validx = SplitBodyParts.reorder_data(valid_x)
testx = SplitBodyParts.reorder_data(test_x)
trainx_2 = SplitBodyParts.reorder_data(train_x_2)
validx_2 = SplitBodyParts.reorder_data(valid_x_2)
testx_2 = SplitBodyParts.reorder_data(test_x_2)
trainx_4 = SplitBodyParts.reorder_data(train_x_4)
validx_4 = SplitBodyParts.reorder_data(valid_x_4)
testx_4 = SplitBodyParts.reorder_data(test_x_4)
trainx_8 = SplitBodyParts.reorder_data(train_x_8)
validx_8 = SplitBodyParts.reorder_data(valid_x_8)
testx_8 = SplitBodyParts.reorder_data(test_x_8)
